                ...
                <div class="report-form">
                    ...
                    <form action="submit">
                        <!-- <fieldset>
                            ...
                            <select id="country" name="country" class="form-control empty">
                                <option value="" disabled selected class="first-country">Country</option>
                            ...
                            <div role="form" class="admin">
                                <p class="title">do you admin a facebook group?</p>
                                <input type="radio" id="yes" name="fav_language" value="Yes">
                                  <label for="yes">Yes</label>
                                  <input type="radio" id="no" name="fav_language" value="No">
                                  <label for="no">No</label>
                            </div>
                            <input type="number" placeholder="How many member does your group have ?">
                        </fieldset>
                        <button type="submit" class="primary-btn center">reach out</button> -->
                        <?php echo do_shortcode('[contact-form-7 id="399" title="Report Form"]'); ?>
                    </form>
